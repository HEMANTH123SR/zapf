  ...
  return (
    ...
    >
      <div className="flex flex-col space-y-1.5 md:space-y-3">
        ...
        <h1 className="font-extrabold text-[2.7rem] sm:text-[2.7rem] md:text-[3.4rem] text-black">
          Your Portfolio, Your Way
        </h1>
        <p
          className={`text-base md:text-lg tracking-wide text-black py-2 ${newAgeFontBold.className}`}
        >
